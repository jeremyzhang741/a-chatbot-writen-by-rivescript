...
base_path = '/jeremyzhang7413/chatbot'

definitions = {'definitions': {'Ask': {'type': 'object', 'properties': {'input': {'type': 'string', 'example': 'hi'}}}, 'Error': {'type': 'object', 'required': ['code', 'message'], 'properties': {'code': {'type': 'string'}, 'message': {'type': 'string'}}}}, 'parameters': {}}

validators = {
    ('ask', 'POST'): {'json': {'$ref': '#/definitions/Ask'}},
}

filters = {
    ('ask', 'POST'): {200: {'headers': None, 'schema': {}}, 400: {'headers': None, 'schema': {}}, 404: {'headers': None, 'schema': {}}},
}
